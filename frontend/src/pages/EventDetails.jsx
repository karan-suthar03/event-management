...
import {HiArrowUpTray, HiOutlineChatBubbleLeftRight} from "react-icons/hi2";
...
const EventDetails = () => {
    ...
    return (
        <div className="min-h-screen p-0 md:p-8 flex flex-col items-center">
            ...
            />
            <div
                className="w-full max-w-4xl mx-auto mt-12 mb-10 p-8 bg-slate-800 rounded-xl shadow-xl border border-slate-700">
                ...
                {feedbacks.length === 0 ? (
                    <div className="text-center py-10">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-16 w-16 mx-auto text-slate-500 mb-4"
                    ...
                    <div className="space-y-6 mb-10">
                        {feedbacks.map((fb, idx) => (
                            <div key={idx}
                                 className="bg-slate-700/50 p-5 rounded-lg shadow border border-slate-600 flex items-start space-x-4">
                                <div className="flex-shrink-0">
                                    <div
                                        className="h-10 w-10 rounded-full bg-sky-500 flex items-center justify-center text-white font-semibold">
                ...
                <form onSubmit={handleFeedbackSubmit}
                      className="bg-slate-700 p-6 rounded-xl shadow-md border border-slate-600 flex flex-col gap-5 max-w-2xl mx-auto">
                    <h3 className="text-xl font-semibold text-sky-300 mb-1">Share Your Experience</h3>
                    <div>
                        <label htmlFor="name" className="block text-sm font-medium text-slate-300 mb-1">Your
                            Name</label> <input
                        type="text"
                        id="name"
                        name="name"
                        ...
                        className="input-field w-full rounded-md border-2 border-slate-600 p-3 focus:outline-none focus:border-sky-500 focus:ring-1 focus:ring-sky-500 bg-slate-800 text-gray-200 placeholder-slate-400 transition duration-150 ease-in-out"
                    ...
                    <div>
                        <label htmlFor="text" className="block text-sm font-medium text-slate-300 mb-1">Your
                    ...
                    <LoadingButton
                        ...
                        disabled={feedbackLoading || !feedbackForm.name || !feedbackForm.text}
                        variant="primary"
                        size="lg"
                        className="w-full"
                    >
                    ...
                    {submitted &&
                        <div className="text-green-400 font-semibold mt-2 text-center">Thank you for your feedback! It
