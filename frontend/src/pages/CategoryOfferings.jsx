...
const CategoryOfferings = () => {
    ...
    return (
        <div className="p-8">
            <section
                className="max-w-7xl mx-auto bg-gradient-to-br from-fuchsia-50 via-pink-50 to-yellow-50 rounded-3xl shadow-2xl border-4 border-fuchsia-100 px-2 md:px-10 py-12">
                <button
                    className="interactive-element mb-6 text-fuchsia-600 hover:underline font-bold flex items-center gap-2"
                    onClick={() => navigate(-1)}
                >
                ...
                <div
                    className="h-1 w-24 bg-gradient-to-r from-pink-300 via-yellow-200 to-fuchsia-300 rounded-full mb-10 mx-auto"></div>
                <div className="flex flex-wrap gap-3 justify-center mb-10">
                    <button
                        className={`interactive-element px-4 py-1.5 rounded-full font-bold border transition-all text-sm ${name === '' ? 'bg-fuchsia-400 text-white border-fuchsia-400' : 'bg-fuchsia-50 text-fuchsia-700 border-fuchsia-200 hover:bg-fuchsia-100'}`}
                    ...
                    {categories.map(cat => (
                        <button
                            key={cat.id}
                            className={`interactive-element px-4 py-1.5 rounded-full font-bold border transition-all text-sm flex items-center gap-1 ${cat.name === name ? 'bg-fuchsia-400 text-white border-fuchsia-400' : 'bg-fuchsia-50 text-fuchsia-700 border-fuchsia-200 hover:bg-fuchsia-100'}`}
