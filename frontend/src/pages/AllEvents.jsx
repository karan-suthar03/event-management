        ...
        <div className="text-gray-100">
            ...
            {loading ? (
                <div className="flex flex-col items-center justify-center py-12">
                    <div
                        className="animate-spin rounded-full h-12 w-12 border-t-2 border-b-2 border-fuchsia-500 mb-4"></div>
                ...
                <div className="space-y-12 pb-0">
                    {sections.map((section) => (<section
                            key={section.title}
                            className="p-4 sm:p-6 rounded-xl shadow-2xl border border-gray-700"
                        >
