...
const EditEvent = () => {
            ...
            <div className="bg-red-900/30 border border-red-700 p-8 rounded-lg shadow-xl text-center max-w-lg w-full">
                ...
                <div className="flex gap-4 justify-center">
                    <button
                        ...
                        className="interactive-element px-5 py-2.5 bg-sky-600 hover:bg-sky-700 text-white rounded-lg font-medium transition-all"
                    >
                        Try Again
                    </button>
                    <button
                        onClick={() => navigate('/admin')}
                        className="interactive-element px-5 py-2.5 bg-slate-600 hover:bg-slate-500 text-sky-300 rounded-lg font-medium transition-all border border-slate-500 hover:border-sky-400"
                    >
                        Back to Dashboard
                    </button>
                </div>
    ...
    if (!event) return (
        <div className="flex flex-col items-center justify-center p-4">
            <div
                className="bg-slate-800/50 border border-slate-700 p-8 rounded-lg shadow-xl text-center max-w-lg w-full">
    ...
    if (success) return (
        <div className="flex flex-col items-center justify-center p-4">
            <div
                className="bg-green-900/30 border border-green-700 p-8 rounded-lg shadow-xl text-center max-w-lg w-full">
    ...
    return (
        <div className="text-slate-300 p-4 md:p-8">
            <div className="max-w-6xl mx-auto">
                ...
                <section className="mb-12 bg-slate-800 rounded-xl shadow-2xl border border-slate-700 p-6 md:p-8">
                    <h2 className="text-2xl font-semibold text-sky-300 mb-6 pb-3 border-b border-slate-700">Event
                        Configuration</h2>
                    <EventEditControls
                        event={event}
                ...
                <section className="mb-12">
                    ...
                    <div className="flex flex-col gap-10 items-center">
                        ...
                        <div className="w-full max-w-xl bg-slate-800 rounded-xl shadow-2xl border border-slate-700 p-6">
                            ...
                            <p className="text-xs text-slate-500 mt-4 text-center">This is how the event card will
                                appear on listing pages.</p>
                        </div>
                        ...
                        <div className="w-full bg-slate-800 rounded-xl shadow-2xl border border-slate-700 p-6">
                            <h3 className="text-xl font-semibold text-sky-300 mb-4 text-center">Full Details
                                Preview</h3>
                            <div className="p-1 bg-slate-850 custom-scrollbar">
                                <EventDetailsLayout event={event}/>
                            </div>
                            <p className="text-xs text-slate-500 mt-4 text-center">This is how the full event details
                                page will look.</p>
                        </div>
                    </div>
                </section>
