...
import {HiCog, HiExclamationTriangle, HiOutlineBell, HiOutlineCheck, HiOutlineTag, HiSwatch} from 'react-icons/hi2';
            ...
            <div className="max-w-5xl mx-auto bg-slate-800 rounded-xl shadow-2xl border border-slate-700 p-6 md:p-8">
                ...
                <section className="mb-10 p-6 bg-slate-700/50 rounded-lg border border-slate-600">
                    ...
                    <div className="bg-slate-800/60 p-4 rounded-md mb-4">
                        <p className="text-slate-300 mb-2">
                            Set a global discount percentage that will apply to all decoration packages, unless they
                            have a specific discount set.
                        </p>
                    ...
                    <div className="flex flex-wrap gap-4 items-end">
                        <div className="flex flex-col">
                            ...
                            className="input-field w-32 px-3 py-2 rounded bg-slate-900 border border-slate-600 text-sky-300 focus:ring-2 focus:ring-sky-500 focus:border-sky-500 outline-none"
                ...
                <section className="mb-10 p-6 bg-slate-700/50 rounded-lg border border-slate-600">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="pt-4"><LoadingButton
                ...
                <section className="p-6 bg-slate-700/50 rounded-lg border border-slate-600">
                    ...
                    <div className="flex flex-wrap gap-3">
                        <button
                            className={`interactive-element px-4 py-2 rounded-md text-sm font-medium transition-all ${
                                theme === 'dark'
